...
4.  Select the **APIs** tab
    ...
    ![](media/media/image31.png){width="3.1666666666666665in"
...
5.  Choose **Authorization** to get the token to call the API operations
    ...
    ![](media/media/image32.png){width="4.267051618547682in"
    height="0.9433956692913386in"}

6.  Select the **GetAccounts** API call or the left side of the screen

    ![](media/media/image33.png){width="2.4291666666666667in"
...
> ![](media/media/image34.png){width="4.635416666666667in"
> height="2.0586996937882764in"}

9.  Scroll to the bottom of the page and click **Send**

    ![](media/media/image35.png){width="0.8645833333333334in"
...
1.  Go to the **API** tab again and choose **Operations** to review all
    ...
    ![](media/media/image37.png){width="6.5in" height="1.59375in"}
...
5.  Your account first result will include the video that you uploaded
    ...
    **\*\*\*Important\*\*\*: Copy the video id (called" id" in the
    ...
    ![](media/media/image40.png){width="3.415094050743657in"
    height="0.8572364391951006in"}

6.  Now choose the **GetVideoIndex** call in the left side of the screen

    ![](media/media/image41.png){width="1.7083333333333333in"
    height="0.4166666666666667in"}
...
7.  click **Try it** and fill in the parameters:
    ...
    d.  **video Id** from *ListVideos call* result
        ...
        ![](media/media/image42.png){width="5.349056211723535in"
